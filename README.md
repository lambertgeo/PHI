...
The deep learning library chosen for the implementation of CNN's was Keras.  It is a collection of Python wrapper programs driving Theano or Tensorflow librarie.  The network used in this research has been built according to Chollet (2016) guidelines.
...
FIRST TESTS
This was run on early versions of Keras Keras version 1 and on Theano.
...
Xception is run on an augmented set of 299*299 images.
